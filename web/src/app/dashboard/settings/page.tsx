  ...
  return (
    <div className="space-y-5">
      ...
      <SettingsGroup
        ...
        description="Moved to its own page — everything for the promotion slide now lives under Promotions in the sidebar."
      >
        <div className="flex flex-wrap items-center justify-between gap-3 rounded-xl border border-border/30 bg-muted/20 p-4">
          <p className="max-w-md text-sm text-muted-foreground">
            Pictures, videos, messages, fit, show/hide, timing, sound and text style for the
            promotion slide are all managed on the <strong>Promotions</strong> page now — one
            clear home.
          </p>
          <a
            href="/dashboard/promotions"
            className="inline-flex items-center rounded-xl bg-primary px-4 py-2 text-sm font-medium text-primary-foreground hover:bg-primary/90"
          >
            Open Promotions
          </a>
        </div>
